...
function hideSideBarAngular() {
    jQuery('body').removeClass('offcanvas-open');
    jQuery('.offcanvas-sidebar').removeClass('is-open');
    jQuery('.open-sidebar').removeClass('close-sidebar');
}
...
function initTestimonialsAngular() {
    jQuery(".slider-entry").owlCarousel({
        ...
        function set_current_menu_for_scroll() {
            ...
            if (menu_arr.length > 0) {
                jQuery.each(menu_arr, function() {
                    ...
                    if (posY > 0) {
                        var new_active = "#" + this;
                        if (jQuery(".k2t-header .k2t-menu > li.active > a").attr("href") == new_active) {} else {
